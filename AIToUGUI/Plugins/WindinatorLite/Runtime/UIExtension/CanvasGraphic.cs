...
namespace Riten.Windinator.Shapes
{
    ...
    public class CanvasGraphic : SignedDistanceFieldGraphic
    {
        ...
        public TextureSDFDrawer TextureSDFBrush { get; private set; }
        ...
        protected override void Awake()
        {
            ...
            TextureSDFBrush = new TextureSDFDrawer(this);
        }
        ...
        protected override void OnValidate()
        {
            ...
            if (LineBrush == null || PolyBrush == null || RectBrush == null || CircleBrush == null || TextureSDFBrush == null)
            {
                Awake();
            }
        } 
